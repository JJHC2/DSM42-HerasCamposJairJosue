...
<div class="row">
    ...
    <div class="col-lg-12 mb-4">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h1 class="m-0 font-weight-bold text-primary">Modificar usuarios</h1>
            </div>
            <div class="card-body">
                
            <form action="{{url('usuarios/' .$usuarios->id) }}" id="edit" method="post">
                {!! csrf_field() !!}
                @method("PATCH")
                <label for="">ID</label>
                ...
                <input class="form-control" type="text" id="name" name="name" value="{{$usuarios->name}}"><br>
                </div>
                <label for=""> Telefono:</label><br>
                <div class="input-group mb-3">
                <span class="input-group-text"><i class="fa-solid fa-phone"></i></span>
                <input class="form-control" type="number" id="phone_number" name="phone_number" value="{{$usuarios->phone_number}}"><br>
                </div>
                <div class="row">
