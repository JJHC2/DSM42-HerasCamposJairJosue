...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Usuario Altas</h1>
</div>
...
<div class="row">
    ...
    <div class="col-lg-12 mb-4">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
            <form action="{{ url('usuarios') }}" id="agregar" method="post">
            {!! csrf_field() !!}
                <label >Nombre:</label>
                <input class="form-control" type="text" placeholder="Ingresa tu Nombre" name="name" id="name" required>
                <div class="form-group">
                <label for="">Numero de Telefono:</label>
                <input type="number" name="phone_number" placeholder="Ingresa tu Numero Telefonico" class="form-control" id="" required>
                </div>
                <div class="row">
                  <a type="submit" class="btn btn-danger m-3" href="/usuarios">Cancelar</a>
