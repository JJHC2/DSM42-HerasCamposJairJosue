            ...
            <div class="d md-flex justify-content-md-end">
                ...
                <span class="input-group-text"><i class="fa-solid fa-magnifying-glass"></i></span>
                        ...
                        <input type="submit" value="Buscar" class="btn btn-success">
                                   ...
                                   <a class="btn btn-success" href="usuarios/create"><i class="fa-solid fa-user-plus"></i></a>
                        </div>
                                ...
                                <table  cellspacing="0" width="100%" class="records_list table table-striped table-bordered table-hover table-condensed" id="mydatatable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="usuarios/{{ $user->id }}" class="btn btn-primary m-6"><i class="fa-solid fa-eye"></i></a></td>
                                                           <td>
                                                            <form action="{{ route('usuarios.destroy',$user->id) }}" class="d-inline formulario-eliminar" method="POST">
                                                            @method('DELETE')
                                                            @csrf
                                                            <button class="btn btn-danger m-6"><i class="fa-solid fa-trash"></i></button>
                                                           </form>
                                                        </td>
                                                            <td><a href="usuarios/{{ $user->id }}/edit" class="btn btn-warning m-6"><i class="fa-solid fa-pen"></i></a></td>
                                                            </tr>
                                                        @endforeach
</tbody>
                                                </table>
